  ...
  return (
    <div className="relative select-none" aria-hidden>
      <svg viewBox="0 0 310 190" className="w-[300px] h-auto">
        ...
        <g className="hm-pulse">
          <rect x={105} y={78} width={100} height={36} rx={9}
            fill="#DCF2EA" stroke={MS} strokeWidth={2} />
          <text x={155} y={93} textAnchor="middle" fontSize={8.5} fontWeight={700} fill={MS}>
            YOUR MANUSCRIPT
          </text>
          <text x={155} y={105} textAnchor="middle" fontSize={7} fill="#101828">
            anchored · versioned
          </text>
        </g>
      </svg>
      ...
      <div
        ...
        style={{ animation: "hmPop 9s ease-out infinite", animationDelay: "5s", opacity: 0 }}
      >
        <div className="text-[9px] font-bold text-uni uppercase tracking-wide">
          Potential literature gap
        </div>
        <div className="text-[9px] text-ink leading-snug">
          2 papers here — none cited yet
        </div>
      </div>
    </div>
  );
